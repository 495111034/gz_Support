...
public class MiniJSON
{
    ...
    public static object JsonDecode(char[] charArray, int index = 0)
    {
        bool success = true;
    ...
    public static string JsonEncode(object json, string tab = null)
    {
        StringBuilder builder = new StringBuilder(BUILDER_CAPACITY);
        bool success = MiniJSON.SerializeValue(json, builder, tab);
    ...
    public static bool SerializeObject(IDictionary anObject, StringBuilder builder, string tab)
    {
        string newtab = null;
        if (tab != null)
        {
        ...
        while (e.MoveNext())
        {
            ...
            builder.Append(":");
            if (!SerializeValue(value, builder, newtab))
            {
                return false;
            }
    ...
    public static bool SerializeArray(IList anArray, StringBuilder builder, string tab)
    {
        string newtab = null;
        if (tab != null)
        {
    ...
    public static bool SerializeValue(object value, StringBuilder builder, string tab)
    {
        ...
        else if (value is IDictionary)
        {
            ...
            SerializeObject((IDictionary)value, builder, tab);
        }
        else if (value is IList)
        {
            ...
            SerializeArray((IList)value, builder, tab);
        }
        ...
        else if ((value is Boolean) && ((Boolean)value == false))
        {
            ...
            SerializeNumber(Convert.ToInt64(value), builder);
