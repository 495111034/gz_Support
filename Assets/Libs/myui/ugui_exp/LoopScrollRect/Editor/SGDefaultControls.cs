...
namespace UnityEngine.UI
{
    public static class SGDefaultControls
    {
        ...
        public static GameObject CreateLoopHorizontalScrollRect(DefaultControls.Resources resources)
        {
            ...
            MyHorizontalLayoutGroup layoutGroup = content.AddComponent<MyHorizontalLayoutGroup>();
            ...
            MyContentSizeFitter sizeFitter = content.AddComponent<MyContentSizeFitter>();
        ...
        public static GameObject CreateLoopVerticalScrollRect(DefaultControls.Resources resources)
        {
            ...
            MyVerticalLayoutGroup layoutGroup = content.AddComponent<MyVerticalLayoutGroup>();
            ...
            var sizeFitter = content.AddComponent<MyContentSizeFitter>();
        ...
        public static GameObject CreateScrollRect(DefaultControls.Resources resources, LayoutType layoutType)
        {
            var scrollName = layoutType == LayoutType.Horizontal ? "Horizontal Scroll Rect" : "Vertical Scroll Rect";
            GameObject root = CreateUIElementRoot(scrollName, new Vector2(200, 200));
            ...
            {
                layoutGroup = content.AddComponent<MyHorizontalLayoutGroup>();
            }
            else
            {
                layoutGroup = content.AddComponent<MyVerticalLayoutGroup>();
            }
            layoutGroup.childAlignment = TextAnchor.MiddleLeft;
            layoutGroup.childForceExpandWidth = false;
            layoutGroup.childForceExpandHeight = true;
