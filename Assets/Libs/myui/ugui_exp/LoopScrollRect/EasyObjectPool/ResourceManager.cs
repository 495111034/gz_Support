    ...
    public class ResourceManager : MonoBehaviour
    {
        ...
        public static ResourceManager Instance
        {
            get
            {
                if (mInstance == null)
                {
                    GameObject GO = new GameObject("UIScrollRectResourceManager", typeof(ResourceManager));
                    ...
                    {
                        if(Application.isEditor) Debug.LogWarning("[ResourceManager] You'd better ignore ResourceManager in Editor mode");
                    }
                }
        ...
        public void InitPool(string poolName,GameObject poolResour, int size, PoolInflationType type = PoolInflationType.DOUBLE)
        {
        ...
        public GameObject GetObjectFromPool(string poolName, bool autoActive = true, int autoCreate = 0)
        {
            ...
            {
                Log.LogError("GetObjectFromPool:pool is not init");
                return null;
            }
        ...
        public void ReturnObjectToPool(GameObject go)
        {
            ...
            {
#if UNITY_EDITOR
                Debug.LogWarning("Specified object is not a pooled instance: " + go.GetLocation());
#endif
            }
            else
            {
