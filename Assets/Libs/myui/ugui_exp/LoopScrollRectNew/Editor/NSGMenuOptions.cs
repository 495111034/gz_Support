...
{
    static internal class NSGMenuOptions
    {
        ...
        static public GameObject GetOrCreateCanvasGameObject()
        {
            ...
            return NSGMenuOptions.CreateNewUI();
        }
        #endregion
        ...
        {
            GameObject go = NSGDefaultControls.CreateLoopHorizontalScrollRect(GetStandardResources());
        ...
        {
            GameObject go = NSGDefaultControls.CreateLoopVerticalScrollRect(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
    }
}