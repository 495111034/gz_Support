...
{
    [AddComponentMenu("UI/MySlider", 33)]
    ...
    public class MySlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        public bool CanDrag { get { return m_mayDrag; }set { m_mayDrag = false; } }
        ...
        {
            if (Application.isPlaying && gameObject.IsActive() && m_mayDrag)
        ...
        {
            return IsActive() && m_mayDrag && IsInteractable() && eventData.button == PointerEventData.InputButton.Left;
        }
