...
public class MyAnnularSlider : Selectable, IDragHandler, ICanvasElement
{
    [Serializable]
    ...
    [SerializeField] private MyImage _fillImage;
    [SerializeField] private MyImage.Origin360 _fillOrigin;
    ...
    public MyImage.Origin360 FillOrigin
    {
    ...
    private void UpdateCachedReferences()
    {
        if (_fillImage)
        {
            _fillImage.type = MyImage.Type.Filled;
            _fillImage.fillMethod = MyImage.FillMethod.Radial360;
    ...
    private float GetAngleFromFillOrigin(Vector2 point)
    {
        ...
        switch (_fillOrigin)
        {
            case MyImage.Origin360.Bottom:
                angle = _clockwise ? 270 - angle : 90 + angle;
                break;
            case MyImage.Origin360.Right:
                angle = _clockwise ? -angle : angle;
                break;
            case MyImage.Origin360.Top:
                angle = _clockwise ? 90 - angle : 270 + angle;
                break;
            case MyImage.Origin360.Left:
