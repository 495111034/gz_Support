	...
	public class TweenPosition : Tween<Vector3> {
        ...
        public override Vector3 value
        {
            ...
            set
            {
                if (is3D)
                {
                    if(cachedTransform.localPosition.x != value.x || cachedTransform.localPosition.y != cachedTransform.localPosition.y || cachedTransform.localPosition.z != cachedTransform.localPosition.z)
                        cachedTransform.localPosition = value;
                }
                else
                {
                    if (cachedRectTransform.anchoredPosition.x != value.x || cachedRectTransform.anchoredPosition.y != value.y)
