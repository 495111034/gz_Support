...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class FastZip
	{
		...
		public void CreateZip(string zipFileName, string sourceDirectory, 
			bool recurse, string fileFilter, string directoryFilter, int compress_level = ICSharpCode.SharpZipLib.Zip.Compression.Deflater.DEFAULT_COMPRESSION)
		{
			CreateZip(File.Create(zipFileName), sourceDirectory, recurse, fileFilter, directoryFilter, compress_level);
		}
		...
		{
			CreateZip(File.Create(zipFileName), sourceDirectory, recurse, fileFilter, null, ICSharpCode.SharpZipLib.Zip.Compression.Deflater.DEFAULT_COMPRESSION);
		}
		...
		public void CreateZip(Stream outputStream, string sourceDirectory, bool recurse, string fileFilter, string directoryFilter,int compress_level)
		{
			...
			using ( outputStream_ = new ZipOutputStream(outputStream) ) {
                ...
                outputStream_.SetLevel(compress_level);
