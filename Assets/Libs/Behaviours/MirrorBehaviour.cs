...
using System.Collections;
    ...
    public class MirrorBehaviour : MonoBehaviour
    {
        ...
        public LayerMask m_ReflectLayers = (int)ObjLayerMask.MirroRef2;
    ...
    public void OnWillRenderObject()
    {
        ...
        reflectionCamera.cullingMask = (int)ObjLayerMask.MirroRef2; 
        ...
        {
            if (mat.HasProperty(resource.ShaderNameHash.ShaderNameId("_ReflectionTex")))
                mat.SetTexture(resource.ShaderNameHash.ShaderNameId("_ReflectionTex"), m_ReflectionTexture);
        }
