Shader "Hidden/PostProcessing/Uber"
{
    HLSLINCLUDE
        ...
        #include "Assets/Libs/Cinemachine/PostProcessing/Shaders/Builtins/Distortion.hlsl"
        #include "Assets/Libs/Cinemachine/PostProcessing/Shaders/Builtins/Dithering.hlsl"
