namespace UnityEngine.Rendering.PostProcessing
{
    ...
    static class ShaderIDs
    {
        ...
        internal static readonly int _BloomBlurGaussH = Shader.PropertyToID("_BloomBlurGaussH");
        internal static readonly int _BloomBlurGaussV = Shader.PropertyToID("_BloomBlurGaussV");
        internal static readonly int _BloomMultiBlur1 = Shader.PropertyToID("_BloomMultiBlur1");
        internal static readonly int _BloomMultiBlur2 = Shader.PropertyToID("_BloomMultiBlur2");
        internal static readonly int _Bloom_Texture = Shader.PropertyToID("_Bloom_Texture");
