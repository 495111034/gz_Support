...
namespace Cinemachine
{
    ...
    public class CinemachineVirtualCamera : CinemachineVirtualCameraBase
    {
        ...
        [Tooltip("初始定位类型")]
        [SerializeField]
        public TimelineVCamTargetType m_PositionType = TimelineVCamTargetType.ActorSelf;
        [SerializeField]
        public int m_PositionAoiType;
        [SerializeField]
        public string m_PositionDataId = ""; 
        [Tooltip("初始定位偏移量，x为角度，y为距离，z为高度")]
        [SerializeField]
        public Vector3 m_PositionOffset = Vector3.zero;
        [Tooltip("注视目标的类型")]
        [SerializeField]
        public TimelineVCamTargetType m_LookAtType = TimelineVCamTargetType.SkillTarget;
        [SerializeField]
        public int m_LookAtAoiType;
        [SerializeField]
        public string m_LootAtDataId = "";
        [Tooltip("跟随目标的类型")]
        [SerializeField]
        public TimelineVCamTargetType m_FollowType = TimelineVCamTargetType.ActorSelf;
        [SerializeField]
        public int m_FollowAoiType;
        [SerializeField]
        public string m_FollowTargetDataId = "";

        [SerializeField]
        public int m_CamObjectTrackId = 0;//挂载在指定轨道的角色下

        [SerializeField]
        public string m_CamObjectNodeName = "";//挂载在指定轨道的角色下指定节点
