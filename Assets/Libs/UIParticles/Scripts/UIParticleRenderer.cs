...
namespace Coffee.UIExtensions
{
    ...
    internal class UIParticleRenderer : MaskableGraphic
    {
        ...
        public void Reset(int index = -1, bool isHideParticleRender = true)
        {
            if (_renderer && isHideParticleRender)
            {
        ...
        public void Set(UIParticle parent, ParticleSystem ps, bool isTrail, bool isHideParticleRender = true)
        {
            _parent = parent;
            maskable = parent.maskable;

            if(gameObject.layer.Equals(parent.gameObject.layer) == false)
            {
