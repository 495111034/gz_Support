...
public static class ShaderVariantCollector
{
    ...
    /// <summary>
    /// 后面用 AssetbundleBuilder.cs 的接口
    /// </summary>
    /// <returns></returns>
    private static List<string> GetAllBuildAssets() {
    ...
    private static List<string> GetAllMaterials()
    {
        ...
        // 获取所有打包的资源
        List<string> buildAssets = GetAllBuildAssets();
        Debug.Log($"AllBuildAssets Count: {buildAssets.Count}");
        ...
        foreach (var path in buildAssets)
        {
            ...
            EditorTools.DisplayProgressBar("获取所有打包资源", ++progressValue, buildAssets.Count);
        }
        ...
        EditorTools.ClearProgressBar();
        Debug.Log($"AllMaterial Count: {allMaterial.Count}");
        // 返回结果
        return allMaterial;
    }
