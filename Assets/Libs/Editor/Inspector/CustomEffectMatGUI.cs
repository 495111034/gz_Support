...
public class CustomEffectMatGUI : ShaderGUI
{
    ...
    private static class Styles
    {
        ...
        public static GUIContent NGUILayerText = new GUIContent("NGUISoft裁剪");
        public static GUIContent NGUILayer2Text = new GUIContent("NGUISoft2裁剪");

        public static GUIContent NGUIMaskTextureText = new GUIContent("NGUI貼圖裁剪");
    ...
    static readonly string NGUIMaskShowName = "_NGUIMaskShown";
    static readonly string NGUIMaskName = "_NGUIMask";

    static readonly string NGUIMask2ShowName = "_NGUIMask2Shown";
    static readonly string NGUIMask2Name = "_NGUIMask2";

    static readonly string NGUIMaskTextureShowName = "_NGUIMaskTextureShown";
    static readonly string NGUIMaskTextureName = "_NGUIMaskTexture";
    ...
    MaterialProperty _NGUIMaskShown = null;
    MaterialProperty _NGUIMask = null;

    MaterialProperty _NGUIMaskTextureShown = null;
    MaterialProperty _NGUIMaskTexture = null;

    MaterialProperty _NGUIMask2Shown = null;
    MaterialProperty _NGUIMask2 = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        _NGUIMaskShown = FindProperty(NGUIMaskShowName, props);
        _NGUIMask = FindProperty(NGUIMaskName, props);

        _NGUIMask2Shown = FindProperty(NGUIMask2ShowName, props);
        _NGUIMask2 = FindProperty(NGUIMask2Name, props);

        _NGUIMaskTextureShown = FindProperty(NGUIMaskTextureShowName, props);
        _NGUIMaskTexture = FindProperty(NGUIMaskTextureName, props);
    ...
    public void ShaderPropertiesGUI(Material material, MaterialProperty[] props)
    {
        ...
        EditorGUI.BeginChangeCheck();
        {
            ...
            EditorGUILayout.BeginVertical("Button");
            {
                ...
                nval = EditorGUILayout.ToggleLeft(Styles.NGUILayerText, _NGUIMask.floatValue == 1, EditorStyles.boldLabel, GUILayout.Width(EditorGUIUtility.currentViewWidth - 60)) ? 1 : 0;
                if (EditorGUI.EndChangeCheck())
                {
                    _NGUIMask.floatValue = nval;
                }
            }
            if (_NGUIMask.floatValue == 1)
            {
                material.EnableKeyword("_NGUI_LAYER_ON");

                Rect rect = GUILayoutUtility.GetLastRect();
                rect.x += EditorGUIUtility.currentViewWidth - 47;
                EditorGUI.BeginChangeCheck();
                float nval = EditorGUI.Foldout(rect, _NGUIMaskShown.floatValue == 1, "") ? 1 : 0;
                if (EditorGUI.EndChangeCheck())
                {
                    _NGUIMaskShown.floatValue = nval;
                }
            }
            else
            {
                material.DisableKeyword("_NGUI_LAYER_ON");
            }
            ...
            EditorGUILayout.BeginVertical("Button");
            {
                ...
                nval = EditorGUILayout.ToggleLeft(Styles.NGUILayer2Text, _NGUIMask2.floatValue == 1, EditorStyles.boldLabel, GUILayout.Width(EditorGUIUtility.currentViewWidth - 60)) ? 1 : 0;
                if (EditorGUI.EndChangeCheck())
                {
                    _NGUIMask2.floatValue = nval;
                }
            }
            if (_NGUIMask2.floatValue == 1)
            {
                material.EnableKeyword("_NGUI_LAYER2_ON");

                Rect rect = GUILayoutUtility.GetLastRect();
                rect.x += EditorGUIUtility.currentViewWidth - 47;
                EditorGUI.BeginChangeCheck();
                float nval = EditorGUI.Foldout(rect, _NGUIMask2Shown.floatValue == 1, "") ? 1 : 0;
                if (EditorGUI.EndChangeCheck())
                {
                    _NGUIMask2Shown.floatValue = nval;
                }
            }
            else
            {
                material.DisableKeyword("_NGUI_LAYER2_ON");
            }
            ...
            EditorGUILayout.BeginVertical("Button");
            {
                ...
                nval = EditorGUILayout.ToggleLeft(Styles.NGUIMaskTextureText, _NGUIMaskTexture.floatValue == 1, EditorStyles.boldLabel, GUILayout.Width(EditorGUIUtility.currentViewWidth - 60)) ? 1 : 0;
                if (EditorGUI.EndChangeCheck())
                {
                    _NGUIMaskTexture.floatValue = nval;
                }
            }
            if (_NGUIMaskTexture.floatValue == 1)
            {
                material.EnableKeyword("_NGUI_TEXTURE_ON");

                Rect rect = GUILayoutUtility.GetLastRect();
                rect.x += EditorGUIUtility.currentViewWidth - 47;
                EditorGUI.BeginChangeCheck();
                float nval = EditorGUI.Foldout(rect, _NGUIMaskTextureShown.floatValue == 1, "") ? 1 : 0;
                if (EditorGUI.EndChangeCheck())
                {
                    _NGUIMaskTextureShown.floatValue = nval;
                }
            }
            else
            {
                material.DisableKeyword("_NGUI_TEXTURE_ON");
            }
