...
namespace WeatherSystem
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "WeatherSystemResourceContainerScript", menuName = "WeatherSystem/Resource Container", order = 998)]
    public class WeatherSystemResourceContainerScript : ScriptableObject
    {
        ...
        public bool TryGetValue<T>(string name, out T value) where T : UnityEngine.Object
        {
            ...
            if (value == null)
            {
                Debug.LogError("Unable to load resource with name " + name + ", have you added it to the 'ResourceContainer' property of WeatherSystemScript?");
                return false;
            }
            return true;
        }
