...
public class FileHelper
{
	...
	public static IList<FileInfo> GetAllFiles(string strPath,string fileEx="*", SearchOption searchOption=SearchOption.AllDirectories)
	{
		...
		for (int idx = 0; idx < max; idx++)
		{
			try
			{
				...
				lstFiles.AddRange(diFliles.GetFiles(fileEx));
			}
			catch
			{
				continue;
